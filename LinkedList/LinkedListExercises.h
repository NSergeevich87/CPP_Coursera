...
/********************************************************************
  ...
  3. You SHOULD NOT call the this function in merge. That would
     result in a very slow running time. (The this function was
...
LinkedList<T> LinkedList<T>::merge(const LinkedList<T>& other) const {
  ...
  // 4. Remember, DO NOT try to use this here. That would be
  //    very slow.

  // Node* leftCurrent = left.head_;
  // Node* rightCurrent = right.head_;
